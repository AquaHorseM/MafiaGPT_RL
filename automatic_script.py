...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default='./shijz_test_12/data')
    parser.add_argument('--config_dir', type=str, default='./shijz_test_12/configs')
    parser.add_argument('--notes_dir', type=str, default='./shijz_test_12/notes')
    parser.add_argument('--prompt_logging_dir', type=str, default='./shijz_test_12/prompt_logging')
