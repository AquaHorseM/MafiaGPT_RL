...
from core.api import init_client
...
def run_game(ipt):
    idx, reflex, player_configs, train, client = ipt
    new = Game(idx, reflex=reflex, openai_client=client)
    new.set_players(player_configs)
    new.run_game(train=train)
    
if __name__ == "__main__":
    args = parser.parse_args()
    init_client(args.openai_config_path)
