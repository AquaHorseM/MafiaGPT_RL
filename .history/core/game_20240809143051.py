    ...
    def set_players(self, player_configs): #player_configs should be a list of dicts
        ...
        for i, num in enumerate(shuffled_nums):
            ...
            if player_type == "reflex":
                ...
                self.all_players.append(switcher_reflex_players[role](i, init_global_info, switcher_private_info[role], prompt_dir_path))
            ...
            if role == "werewolf":
                ...
                if player_type == "baseline":
                    ...
                    assert os.path.exists("core/players/prompts/villager"), "Villager prompt directory not found"
                    self.all_players.append(VillagerPlayer(i, init_global_info, init_villager_private_info, "core/players/prompts/villager"))
            elif role == "medic":
                if player_type == "baseline":
