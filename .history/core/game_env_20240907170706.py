...
class GameEnv:
    def __init__(self, id=1, train = False, openai_client = None, data_path = None):
        ...
        #The action space and observation space are set to None initially
        self.action_space = []
    ...
    def init_env(self):
        ...
        self.observation_space = Box(low = 0, high = 1, shape = (self.player_num * self.player_num * 4,), dtype = np.float32)
