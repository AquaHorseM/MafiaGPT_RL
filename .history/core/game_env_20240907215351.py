...
class GameEnv:
    ...
    def step(self, actions):
        ...
        if self.game_status["cur_stage"] == "night":
            ...
            is_werewolf = self.all_players[seer_id].get_role() == "werewolf"
            ...
            self.add_event({"event": "inquiry", "content": {"player": seer_id, "target": seer_target, "is_werewolf": is_werewolf, "reason": reason}, "visible": seer_id})
