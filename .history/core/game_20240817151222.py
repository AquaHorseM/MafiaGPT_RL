...
class Game:
    ...
    def act(self, player_id, available_actions = None):
        if self.player_types[player_id] == "baseline":
            return self.all_players[player_id].act(self)
        else:
            return self.all_players[player_id]._act(self.event_book, available_actions)
