...
from core.players.utils import get_prompt, parse_data
...
class Player:
    ...
    def reflex_single_pair(self, prev_hstate, new_events, next_hstate, pred_hstate, alpha):
    ...
    def reflex(self, data, sample_num = 5, alpha = 0.5):
        reflex_data = parse_data(data, self.id)
        ...
        for d in reflex_data:
            ...
            response = self.reflex_single_pair(prev_hstate, events, next_hstate, pred_hstate, alpha)
