...
class WerewolfGameEnv:
    ...
    def convert_available_actions_to_description(self, available_actions, player_id):
        avail_des = []
        for potential_actions in ["speak", "vote", "kill", "heal", "see"]:
            if potential_actions in available_actions:
                avail_des.append(potential_actions)
    
    def get_actions_from_player(self, player_id, available_actions):
