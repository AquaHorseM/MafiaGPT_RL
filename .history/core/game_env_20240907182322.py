...
class GameEnv:
    ...
    def step(self, actions):
        ...
        if self.game_status["cur_stage"] == "night":
            ...
            self.add_event({"event": "heal", "content": {"player": medic_id, "target": heal_target}, "visible": "medic"})
            self.add_event({"event": "see", "content": {"player": seer_id, "target": seer_target}, "visible": "seer"})
            self.add_event({"event": "kill", "content": {"player": werewolf_ids[-1], "target": kill_target}, "visible": "werewolf"})
